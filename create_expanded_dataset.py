...
if os.path.isfile(os.path.join(path_original, 'expanded', 'base_expanded_test.csv')):
    print("Load base_expanded_test")
    base_exp_test = pd.read_csv(os.path.join(path_original, 'expanded', 'base_expanded_test.csv'))
